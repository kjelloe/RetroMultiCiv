...
3. Definition of done, every item: `node --test test/` fully green
   (currently 302 tests), the item's own verification steps pass, related
...
tests); revert-proof the guard block. Full suite 302/302, twins green.
