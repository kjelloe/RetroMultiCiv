...
| SO4 | Civilopedia | pedia.js/pedia-concepts.js | PRESENT — R19; 16 concept articles (gate 14) + run-F #9 per-unit/building flavor blurbs (PediaBlurbs.luau, 28 units + 21 buildings ported verbatim from the committed ally source, gate 16 parity + ruleset coverage; browser unitBlurbs/buildingBlurbs authored from the same source stays in lockstep) |
