# Designer-ally response — unit + building Civilopedia blurbs (2026-07-19)

Verbatim ally copy answering `ally-unit-building-blurb-request-2026-07-19.md`
(28 units, barbleader excluded; 21 buildings). Original prose, keyed by `id`,
`id → blurb`. For integration into a `unitBlurbs` + `buildingBlurbs` data table
(tech-blurbs.js precedent) + the Roblox parity gate — architect/helper/roblox
lane.
