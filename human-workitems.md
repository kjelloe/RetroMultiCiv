...
_Last synced: 2026-08-13 (tip on `dev_night`; **marker-0119 = the graphics
v2 ladder, merge-consistent**, supersedes 0113-0118. v1.0.0 + v1.0.1 are
...
- [ ] **A1. Review the tier sheet:** `debugging/gallery-tiers-comparison.png`
  ...
  landed provisionals.
- [ ] **A2. Merge marker-0119 to main and redeploy:**
  `git fetch origin --tags && git checkout main && git merge marker-0119 &&
