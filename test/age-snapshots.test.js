...
const CANONICAL_PIN = { seed: 7, size: 'small', age: 'renaissance', civs: 7, statehash: '0x745d72b9' }; // W6 slice-1d (garrison role discipline — the ff AI now holds garrisons + develops)
