...
const CANONICAL_PIN = { seed: 7, size: 'small', age: 'renaissance', civs: 7, statehash: '0x59e9a83b' }; // W6 slice-3 (city roles + war pair — rules.json stamp + role-driven ff development)
