...
const CANONICAL_PIN = { seed: 7, size: 'small', age: 'renaissance', civs: 7, statehash: '0x2b68f75b' }; // W6 slice-1c FINAL (deferPop 3 + highFoodSurplus 2 — the measured defer calibration)
