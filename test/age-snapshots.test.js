...
const CANONICAL_PIN = { seed: 7, size: 'small', age: 'renaissance', civs: 7, statehash: '0xbfdaefb4' }; // W6 slice-1b (coverage fix: doctrine no longer threat-gated — the ff AI builds under chronic threat too)
