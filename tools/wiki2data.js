...
const TARGET_TITLES = [
  ...
  // ('List of terrain in Civ1' was a table-less redirect stub — dropped by the
  // #1205 per-page table gate; 'Terrain (Civ1)' below is the real page)
  'Terrain (Civ1)',
  // ("Sid Meier's Civilization" — the game overview — carried ZERO tables and
  // no consumer; dropped by the same gate. The extraction exists for TABLES
  // (mapdata parses them; prose is CC BY-SA and unusable anyway).)
